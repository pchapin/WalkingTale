...
//    @DynamoDBAutoGeneratedKey todo, make id a string so it can be auto generated by ddb
    ...
    public Repo(String id, @NonNull String name, String description, List<Chapter> chapters, String genre, String tags, String duration, Double rating, Double latitude, Double longitude, String story_image) {
        this.id = id;
        this.name = name;
